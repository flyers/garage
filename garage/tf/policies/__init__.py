...
from garage.tf.policies.continuous_conv_policy import ContinuousConvPolicy
...
__all__ = [
    ...
    "CategoricalLSTMPolicy", "CategoricalMLPPolicy", "ContinuousMLPPolicy", "ContinuousConvPolicy",
